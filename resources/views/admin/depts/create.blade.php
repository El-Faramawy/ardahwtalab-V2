	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-right6 position-right"></i> <span class="text-semibold">الأقسام</span> - اضافة قسم
				</h4>
			</div>
		</div>
	...
	<div class="content">
		...
		<div class="panel panel-flat table-responsive">
			<div class="panel-body">
				<form action="{{ route('depts.store') }}" class="form-horizontal" method="post"
