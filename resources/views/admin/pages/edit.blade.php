		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-right"></i> <span class="text-semibold">الصفحات</span> - تعديل صفحة</h4>
				</div>
			</div>
		...
		<div class="content">
			...
			<div class="panel panel-flat table-responsive">
				<div class="panel-body">
					<form action="{{ route('pages.update',$info->id) }}" class="form-horizontal" method="post">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="input-group">
										...
										<input type="link" value="{{$info->link}}" class="form-control" name="link">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<select name="footer" id="" class="form-control">
										...
										<option {{ $info->footer ? 'selected' : '' }} value="1">نعم</option>
									</select>
									</div>
								</div>
							</div>
