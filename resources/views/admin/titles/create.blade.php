@extends('admin.index')
@section('title') اضافة عنوان الخصائص @stop
@section('page')
<!-- Main content -->
	...
	<div class="content">
		...
		<div class="panel panel-flat table-responsive">
			<div class="panel-body">
				<form action="{{ route('titles.store') }}" class="form-horizontal" method="post"
							...
							<div class="col-lg-10">
								<div class="input-group">
									...
									<select required class="form-control" name="dept_id" data-live-search="true"
										id="dept_titles" data-action="{{route('gettitles')}}">
