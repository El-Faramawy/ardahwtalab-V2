...
@section('title') طلبات الانضام @stop
	...
	<div class="page-header">
		...
		<div class="breadcrumb-line">
			...
			<ul class="breadcrumb">
				...
				<li><a href="{{route('lawyers.index',['type' => 'requests'])}}">طلبات الانضمام</a></li>
			...
			<table class="table datatable-key-basic">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							@if($info->status != 1)
							<a class="btn btn-success fa fa-check-circle-o"
								href="{{route('lawyers.edit',$info->id)}}?process=active"></a>
							@else
							مُفعل
							@endif
						</td>
						...
						<td><a class="btn btn-primary fa fa-pencil"
								href="{{route('lawyers.edit',$info->id)}}"></a></td>
