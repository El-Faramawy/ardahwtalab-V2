		...
		<div class="page-header">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-right6 position-right"></i> <span class="text-semibold">الدول</span> - تعديل دولة</h4>
				</div>
			</div>
		...
		<div class="content">
			...
			<div class="panel panel-flat table-responsive">
				<div class="panel-body">
					<form action="{{ route('country.update',$info->id) }}" class="form-horizontal" method="post">
						{{ method_field('PUT') }}
