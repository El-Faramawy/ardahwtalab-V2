                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td align="left" class="bodyTitle" id="bodyText-8" style="font-family: &#39;Open Sans&#39;, Arial, Helvetica, sans-serif; font-size: 16px; line-height: 24px; color: #6f6f6f;">
                                                                                                                        <p style="margin-top: 0px; margin-bottom: 0px; line-height: 24px; text-align: center;">تم تسجيل حسابك بنجاح .... لتفعيل حسابك يرجى زيارة الرابط أدناة</p>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                        ...
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <!--[if mso]> 												<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $link = route('auth.active',[$user_id,$token]) }}" style="height:50px;v-text-anchor:middle;width:229px;" arcsize="90%" stroke="f" fillcolor="#6d1c1c"> 												<w:anchorlock/> 												<center> 												<![endif]--><a class="mlContentButton" href="{{ $link = route('auth.active',[$user_id,$token]) }}" style="font-weight: 400; font-family: Verdana, Geneva, sans-serif; border-radius: 45px; color: #ffffff; display: inline-block; font-size: 14px; background-color: #6d1c1c; line-height: 20px; padding: 15px 0 15px 0; text-align: center; text-decoration: none; width: 200px;">رابط التفعيل</a>
