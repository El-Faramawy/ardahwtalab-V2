                                ...
                                <td align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" class="mlContentTable">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="left" style="font-family: &#39;Open Sans&#39;, Arial, Helvetica, sans-serif; color: #111111; font-size: 15px; line-height: 18px;"> </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" height="20"></td>
                                            </tr>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td align="left" class="bodyTitle" id="bodyText-8" style="font-family: &#39;Open Sans&#39;, Arial, Helvetica, sans-serif; font-size: 20px; line-height: 24px; color: #6f6f6f;">
                                                                                                                        <p style="margin-top: 0px; margin-bottom: 0px; line-height: 24px; text-align: center;"> السلام عليكم ورحمة الله وبركاته,<br />
                                                                                                                            وأسعد الله أوقاتكم . بشأن الطلب الخاص بكم <br />
                                                                                                                           "<b>{{ $lawsuit->content }}</b>"<br />
                                                                                                                            نفيدكم بأنه يمكنكم الاطلاع على عرض السعر مجاناً من خلال لوحة التحكم الخاصة بكم وفي حال رغبتكم بالتوسط وربطكم بالمحامي صاحب العرض نأمل استكمال سداد عمولة الموقع من خلال نفس نموذج عرض السعر في لوحة التحكم .
                                                                                                                    ...
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <!--[if mso]> 												<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ route('lawsuits.index' , ['lawsuit_id' => $lawsuit->id]) }}" style="height:50px;v-text-anchor:middle;width:229px;" arcsize="90%" stroke="f" fillcolor="#6d1c1c"> 												<w:anchorlock/> 												<center> 												<![endif]--><a class="mlContentButton" href="{{ route('lawsuits.index' , ['lawsuit_id' => $lawsuit->id]) }}" style="font-weight: 400; font-family: Verdana, Geneva, sans-serif; border-radius: 45px; color: #ffffff; display: inline-block; font-size: 20px; background-color: #6d1c1c; line-height: 20px; padding: 15px 0 15px 0; text-align: center; text-decoration: none; width: 300px;">استكمال عملية الدفع</a>
                                                                                ...
                                                                                <td align="center" style="padding: 0px 40px; border-top: 1px solid #d4d4d4; border-bottom: 1px solid #d4d4d4;" class="mlContentOuter">
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" align="center" id="navBlock-12">
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center" height="20" class="spacingHeight-20" style="line-height: 20px; min-height: 20px;">
